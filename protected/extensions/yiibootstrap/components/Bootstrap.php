...
class Bootstrap extends CApplicationComponent
{
	...
	public function registerCoreCss()
	{
		Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/bootstrap.css');
                Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/docs.css');
                Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/bootstrap-responsive.css');
	}
