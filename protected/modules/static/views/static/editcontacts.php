...
<?php
if(Yii::app()->user->hasFlash('contact saved')) :
{ ?>
   <br/>
<div class="alert alert-block span5"><?=Yii::app()->user->getFlash('contact saved');?></div>
<?php }
else :
?> 
...
<!--div class="span4"-->
    ...
    <?php echo CHtml::activeTextArea($model,'contacts', array('rows'=>'23', 'class'=>'input-xlarge')); ?>
    </div>          
    <br/>    
    <div class="row">
