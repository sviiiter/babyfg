<h1>Редактировать Оплата и Доставка</h1>
<?php
if(Yii::app()->user->hasFlash('payment saved')) :
{ ?>
   <br/>
<div class="alert alert-block span5"><?=Yii::app()->user->getFlash('payment saved');?></div>
<?php }
else :
?> 
...
<!--div class="span4"-->
    ...
    <div class="span5"  style="margin-left: 27px;">    
   
    <?php echo CHtml::errorSummary($model,'<div class="alert alert-error span4">','</div>'); ?>
        <br/>
    <div class="row">
    <?php echo CHtml::activeLabel($model,'payment'); ?> 
    <?php echo CHtml::activeTextArea($model,'payment', array('rows'=>'23', 'class'=>'input-xlarge')); ?>
    </div>    
    <div class="row">
